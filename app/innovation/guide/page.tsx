...
import { Printer, ArrowLeft, Check, Lock } from 'lucide-react';
...
export default function AudioQRGuidePage() {
    ...
    if (authState === 'loading') return <div className="min-h-screen bg-white flex items-center justify-center text-hotel-bronze">Loading...</div>;
    if (authState === 'login') return <LoginGate message="Please log in to access this resource." subMessage="This section is available to Hotel Partners." />;
