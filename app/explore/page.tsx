...
export default function ExplorePage() {
 ...
 {user ? (
   <Link href="/dashboard" className="bg-hotel-bronze text-white px-5 py-2 text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-hotel-black transition-colors hidden sm:block">
     Dashboard
   </Link>
 ) : (
   <div className="flex gap-4">
     <Link href="/login" className="text-white/60 hover:text-white text-[10px] font-bold uppercase tracking-widest transition-colors hidden sm:block pt-2">
       Sign In
     </Link>
     <Link href="/signup" className="bg-hotel-bronze text-white px-5 py-2 text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-hotel-black transition-colors hidden sm:block">
       Sign Up
     </Link>
   </div>
 )}
 ...
 <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
   ...
   <div className="relative w-full md:w-72">
     ...
     <input 
       ...
       className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-sm text-sm focus:outline-none focus:border-hotel-bronze focus:ring-1 focus:ring-hotel-bronze transition-all"
     />
   </div>
 </div>
 </div>
